...
def P_execute(self: dict, instructions: int = 0, debug: bool = False) -> None:
    ...
    while (self["instructions"] < instructions):
        ...
        print("PC     :", self["program_counter"]-1, hex(self["program_counter"]-1))
        print("A(temp):", self["reg_a"], hex(self["reg_a"]))
        print("X(i)   :", self["reg_x"], hex(self["reg_x"]))
        print("Y(y)   :", self["reg_y"], hex(self["reg_y"]))
        for addr, name in [("0200", "x"), ("0201", "y"), ("0202", "a"), ("0203", "b")]:
            num = int("0x"+addr, base=16)
            value = self["memory"]["memory"].get(num, 0)
            print(f"${addr}{name} :", value, hex(value))
        u = self.copy()
        del u ["memory"]
        print(u)
        print()
...
memory = M___init__({"32768": 169, "32769": 5, "32770": 141, "32771": 0, "32772": 2, "32773": 169, "32774": 3, "32775": 141, "32776": 1, "32777": 2, "32778": 169, "32779": 1, "32780": 141, "32781": 2, "32782": 2, "32783": 162, "32784": 0, "32785": 169, "32786": 0, "32787": 141, "32788": 3, "32789": 2, "32790": 160, "32791": 0, "32792": 173, "32793": 3, "32794": 2, "32795": 24, "32796": 109, "32797": 2, "32798": 2, "32799": 141, "32800": 3, "32801": 2, "32802": 200, "32803": 204, "32804": 0, "32805": 2, "32806": 208, "32807": 240, "32808": 173, "32809": 3, "32810": 2, "32811": 141, "32812": 2, "32813": 2, "32814": 232, "32815": 236, "32816": 1, "32817": 2, "32818": 208, "32819": 221, "32820": 173, "32821": 2, "32822": 2, "32823": 76, "32824": 55, "32825": 128, "65532": 0, "65533": 128})
cpu = P___init__(memory)
cpu, _ = P_execute(cpu, 1000)
