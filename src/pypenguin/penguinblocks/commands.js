...
//  |=======================================|
  ...
  // Temporary Variables
  {
    id: "lmsTempVars2.setThreadVariable",
    spec: "set thread var %1 to %2",
    inputs: ["%n", "%n"],
    shape: "stack",
    category: "lmsTempVars2",
  },
  {
    id: "lmsTempVars2.changeThreadVariable",
    spec: "change thread var %1 by %2",
    inputs: ["%n", "%n"],
    shape: "stack",
    category: "lmsTempVars2",
  },
  {
    id: "lmsTempVars2.getThreadVariable",
    spec: "thread var %1",
    inputs: ["%n"],
    shape: "reporter",
    category: "lmsTempVars2",
  ...
  {
    id: "lmsTempVars2.threadVariableExists",
    spec: "thread var %1 exists?",
    inputs: ["%n"],
    shape: "boolean",
    category: "lmsTempVars2",
  },
  {
    id: "lmsTempVars2.forEachThreadVariable",
    spec: "for %1 in %2 {BODY}",
    inputs: ["%n", "%n"],
    shape: "stack",
    category: "lmsTempVars2",
  },
  {
    id: "lmsTempVars2.listThreadVariables",
    spec: "active thread variables",
    inputs: [],
    shape: "reporter",
    category: "lmsTempVars2",
  },
  ...
  {
    id: "lmsTempVars2.changeRuntimeVariable",
    spec: "change runtime var %1 by %2",
    inputs: ["%n", "%n"],
    shape: "stack",
    category: "lmsTempVars2",
  },
  {
    id: "lmsTempVars2.getRuntimeVariable",
    spec: "runtime var %1",
    inputs: ["%n"],
    shape: "reporter",
    category: "lmsTempVars2",
  ...
  {
    id: "lmsTempVars2.runtimeVariableExists",
    spec: "runtime var %1 exists?",
    inputs: ["%n"],
    shape: "boolean",
    category: "lmsTempVars2",
  },
  {
    id: "lmsTempVars2.deleteRuntimeVariable",
    spec: "delete runtime var %1",
    inputs: ["%n"],
    shape: "stack",
    category: "lmsTempVars2",
  },
  {
    id: "lmsTempVars2.deleteAllRuntimeVariables",
    spec: "delete all runtime variables",
    inputs: [],
    shape: "stack",
    category: "lmsTempVars2",
  },
  {
    id: "lmsTempVars2.listRuntimeVariables",
    spec: "active runtime variables",
    inputs: [],
    shape: "reporter",
    category: "lmsTempVars2",
  },
  ...
  // JSON
  {
    id: "jgJSON.json_validate",
    spec: "is json %1 valid?",
    inputs: ["%n"],
    shape: "boolean",
    category: "jgJSON",
  },
  {
    id: "jgJSON.getValueFromJSON",
    spec: "get %1 from %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  ...
  {
    id: "jgJSON.getTreeValueFromJSON",
    spec: "get path %1 from %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  ...
  {
    id: "jgJSON.json_delete",
    spec: "in json %2 delete key %1",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_values",
    spec: "get all values from json %1",
    inputs: ["%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  ...
  {
    id: "jgJSON.json_array_validate",
    spec: "is array %1 valid?",
    inputs: ["%n"],
    shape: "boolean",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_split",
    spec: "create an array from text %1 with delimeter %2",
    inputs: ["%n", "%n"],
    shape: "boolean",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_join",
    spec: "create text from array %1 with delimeter %2",
    inputs: ["%n", "%n"],
    shape: "boolean",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_push",
    spec: "in array %1 add %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_concatLayer1",
    spec: "add items from array %1 to array %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_concatLayer2",
    spec: "add items from array %1 and array %2 to array %3",
    inputs: ["%n", "%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_delete",
    spec: "in array %1 delete %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_reverse",
    spec: "reverse array %1",
    inputs: ["%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_insert",
    spec: "in array %1 insert %2 at %3",
    inputs: ["%n", "%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_set",
    spec: "in array %1 set %2 to %3",
    inputs: ["%n", "%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_get",
    spec: "in array %1 get %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_indexofNostart",
    spec: "in array %1 get index of %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_indexof",
    spec: "in array %1 from %2 get index of %3",
    inputs: ["%n", "%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_length",
    spec: "length of array %1",
    inputs: ["%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_contains",
    spec: "array %1 contains %2 ?",
    inputs: ["%n", "%n"],
    shape: "boolean",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_flat",
    spec: "flatten nested array %1 by %2 layers",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_getrange",
    spec: "in array %1 get all items from %2 to %3",
    inputs: ["%n", "%n", "%n"],
    shape: "reporter",
    category: "jgJSON",
  },
  {
    id: "jgJSON.json_array_isempty",
    spec: "is array %1 empty?",
    inputs: ["%n"],
    shape: "reporter",
    category: "jgJSON",
  },
