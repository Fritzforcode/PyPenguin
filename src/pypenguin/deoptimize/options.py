...
def translateOptions(optionDatas, opcode, spriteName, tokens):
    ...
    for i,optionID,optionData in ikv(optionDatas):
        ...
        elif mode in ["key", "unary math operation", "binary math operation large", "binary math operation small", "text operation", "text case", "stop script target", "other sprite or stage", "cloning target", "up | down", "backdrop", "LOUDNESS | TIMER", "string"]:
